import {
  ...
  import { styleWeatherLondon } from "../styles/styleWeather";
  ...
  const WeatherLondon = (): React.JSX.Element => {
    ...
    return (
     <View style={styleWeatherLondon.container}>
      ...
      <Text style= {styleWeatherLondon.temp}>{state.data.main.temp} C</Text>
      <Text style= {styleWeatherLondon.weatherMain}>{state.data.weather[0].main} </Text>
      <Text style= {styleWeatherLondon.weatherDescription}>{state.data.weather[0].description} </Text>
      <FlatList
